...
Purpose:
    ...
    During the process, it cleans and transforms the data before loading it into
    the Silver tables.

Steps:
    - Clear the existing data in the Silver tables.
    - Clean and transform the data from the Bronze tables.
    - Load the cleaned data into the Silver tables.
